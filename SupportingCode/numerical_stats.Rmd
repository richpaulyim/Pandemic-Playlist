---
title: "Untitled"
author: "Victoria Coronado 405314668"
date: "3/1/2021"
...
#to incorporate into cor plot later
data$label01 <- ifelse(data$label == "before", 0, 1) 
```
...
```{r}
library(corrplot)
corrplot(cor, method = "color", addCoef.col = "black", number.cex = .7, type = "upper", tl.cex=0.8)
```
